    ...
    <TouchableOpacity onPress={() => setExpand(!expand)}>
      <View className="my-2 bg-primary-mild p-4 rounded-xl">
        ...
        <View className="flex flex-row justify-between mb-2 w-full">
          ...
          <View>
            <Text className="text-gray-600 text-sm p-2 px-4 bg-orange-300 rounded-2xl">
              {props.item.status}
            </Text>
          </View>
        </View>
        ...
        {expand ? (
          <View className="flex flex-row justify-between w-full mt-4 pb-2">
            <View className="w-[48%]">
              <TouchableOpacity
                className="bg-mild-green p-4 rounded-lg"
                onPress={() => setStatus("Approved")}
              >
                <Text className="text-gray-800 text-center font-opensans-medium">
                  Approve
                </Text>
              </TouchableOpacity>
            </View>
            <View className="w-[48%]">
              <TouchableOpacity
                className="bg-mild-red p-4 rounded-lg"
                onPress={() => setStatus("Rejected")}
              >
                <Text className="text-white text-center font-opensans-medium">
                  Reject
                </Text>
              </TouchableOpacity>
            </View>
